...
ablation_code=0 #0 = 'unfiltered_imputed', 1 = 'filtered_imputed', 2 = 'unfiltered_unimputed', 3 = 'filtered_unimputed', 4 = 'main folder'
python $PWD/preprocess_$dataset.py $root_directory $data_directory $filter_data $normalize_data $threshold $history_window $prediction_window $ablation_code