...
def create_time_series():
    ...
    if not path.exists(data_directory +  seg):
        os.mkdir(data_directory + seg)
    with open(data_directory + seg + 'multivariate_continuous_train_subsets.pickle', 'wb') as f:
        pickle.dump(all_subjects_train_data, f, pickle.HIGHEST_PROTOCOL)
    with open(data_directory + seg + 'multivariate_continuous_test_subsets.pickle', 'wb') as f:
...
def get_windowed_data():
    train_data = window_data(data_directory + seg + 'multivariate_continuous_train_subsets.pickle')
    test_data = window_data(data_directory + seg + 'multivariate_continuous_test_subsets.pickle')
    ...
    with open(data_directory + seg + 'windowed_train_' + substring, 'wb') as f:
        # Pickle the 'all_subjects_data' dictionary using the highest protocol available.
        pickle.dump(train_data , f, pickle.HIGHEST_PROTOCOL)
    with open(data_directory + seg + 'windowed_test_' + substring, 'wb') as f:
        # Pickle the 'all_subjects_data' dictionary using the highest protocol available.
